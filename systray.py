...
class WindowsBalloonTip(object):
    def __init__(self, title, msg):
        ...
        self.hwnd = win32gui.CreateWindow(class_atom, "Taskbar", style, 0, 0, win32con.CW_USEDEFAULT,
                                          ...
                                          0, 0, hinst, None)
        win32gui.UpdateWindow(self.hwnd)
        iconPathName = os.path.abspath(os.path.join(sys.path[0], "alarm-clock.ico"))
        icon_flags = win32con.LR_LOADFROMFILE | win32con.LR_DEFAULTSIZE
        try:
...
if __name__ == '__main__':
    ...
    hover_tooltip = "SysTrayIcon.py Demo"
    ...
    menu_functions = (('Say Hello', icons.__next__(), hello),
    ...
    SysTrayIcon(icons.__next__(), hover_tooltip, menu_functions, on_quit=bye, default_menu_index=1)
